...
- [x] 已完成 Agent Token 效率 P0-P2：工作流预算、动态 Prompt/FSI、原生工具调用、增量上下文、自适应团队扇出和浪费归因。
- [x] 详细任务、默认值、兼容开关与验收口径见 `docs/TOKEN_EFFICIENCY_ROADMAP_P0_P2.md`。
- [-] 生产环境继续比较 Token/有效产物与推荐、因子、策略核心效果，Token 降低不得以效果下降为代价。
