...
export const GOLDEN_MARKET_DATASET: Array<{
...
}> = [
  {
    ...
    provenance: {
      ...
      dataAsof: "2026-07-10T23:59:59.000Z",
      adjustType: "post",
      security: {
        symbol: "AAPL",
        exchange: "US",
        listingStatus: "active",
        listedAt: "1980-12-12T00:00:00.000Z",
      },
    },
    expectedValid: true,
  },
  {
    ...
    provenance: {
      ...
      dataAsof: "2026-07-11T07:00:00.000Z",
      adjustType: "pre",
      security: { symbol: "600519", exchange: "SH", listingStatus: "active" },
    },
    expectedValid: false,
    expectedError: "future_bar",
  },
  {
    id: "hk-post-delist",
    market: "HK",
    ...
    provenance: {
      ...
      security: {
        ...
        delistedAt: "2026-07-09T00:00:00.000Z",
      },
    },
    expectedValid: false,
    expectedError: "bar_after_delisting",
  },
  {
    id: "us-invalid-ohlc",
    market: "US",
