...
export const STRATEGY_AUTHORING_SCENARIO: ResearchScenarioSpec = {
  ...
  loopDefaults: { maxIterations: 10, reactLoop: true },
  status: "enabled",
  sortOrder: 20,
  isBuiltin: true,
};
...
export const STOCK_SCREENING_SCENARIO: ResearchScenarioSpec = {
  ...
  toolPreset: {
    builtinTools: ["run_screener", "recommendation.record", "fetch_klines"],
    connectors: ["qubit-data", "qubit-research"],
    mcpServers: [],
    defaultParams: {},
  },
...
export const LIVE_TRADING_SCENARIO: ResearchScenarioSpec = {
  ...
  loopDefaults: { maxIterations: 8, reactLoop: true, requireRiskVeto: true },
  status: "enabled",
  sortOrder: 90,
  isBuiltin: true,
};
