...
7. **结论 & 主要风险**。${FSI_ZH_MARKET_RESEARCH}${FSI_ZH_MODEL_BUILDER}`;
...
2. MCP（如 fsi-factset / mathjs / mcp-financex）做精确计算
...
数据不足 → hold + confidence < 0.5 + 列出待补项；禁止编造财务数据。${FSI_ZH_MODEL_BUILDER}`;
