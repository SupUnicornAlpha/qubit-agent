-- down 0106: revert sim from dispatch/execution mode CHECKs (map sim → paper)
PRAGMA foreign_keys=OFF;
--> statement-breakpoint
UPDATE execution_task SET dispatch_mode = 'paper' WHERE dispatch_mode = 'sim';
--> statement-breakpoint
UPDATE strategy_runtime SET execution_mode = 'paper' WHERE execution_mode = 'sim';
--> statement-breakpoint
