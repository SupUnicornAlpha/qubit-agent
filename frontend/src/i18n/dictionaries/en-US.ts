    ...
    simpleMode: {
      ...
      pages: {
        ...
        tasks: {
          ...
          description: "Review recurring research, monitoring, and execution jobs with only the essential controls exposed.",
          activeCount: "active",
          totalCount: "tasks",
          nextRun: "Next run",
          runNow: "Run now",
          enabled: "Enabled",
          paused: "Paused",
          empty: "No automations yet. Create the first scheduled research job in the pro workspace.",
        },
        alerts: {
          eyebrow: "ATTENTION",
