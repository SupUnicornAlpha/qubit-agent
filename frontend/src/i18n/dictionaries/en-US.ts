...
const pack: LocalePack = {
  ...
  translations: {
    ...
    app: {
      hint: {
        tauriBackendStarting: "The embedded backend process is running; waiting for its API…",
    ...
    topbar: {
      ...
      restart: {
        ...
        failure: "Restart failed: {detail} ({url})",
      },
      status: {
    ...
    simpleMode: {
      navigationLabel: "Simple mode navigation",
      nav: { chat: "Chat", tasks: "Tasks", alerts: "Alerts", memory: "Memory", files: "Artifacts" },
      online: "Service online",
      offline: "Service offline",
      advanced: "Pro workspace",
      newChat: "New chat",
      ...
      composerPlaceholder: "Ask about markets, stocks, factors, or strategies; use @ for context…",
      connectionError: "The research service is not connected. Start the backend or try again shortly.",
      prompts: {
        market: "Analyze today's market regime and major risks",
        stock: "Research a stock with entry, exits, and invalidation conditions",
        factor: "Turn an investment hypothesis into a testable factor",
        strategy: "Convert my strategy idea into rules and backtest it",
      },
      disclaimer: "Research is decision support only. Verify important conclusions against data timestamps and your own risk constraints.",
      pages: {
        ...
        tasks: {
          ...
          title: "Agent tasks",
          description: "See sub-agent work for the current conversation, including its A2A delegation context.",
          activeCount: "active",
          totalCount: "tasks",
        ...
        alerts: {
          ...
          description: "Operational exceptions, risk signals, and system notices that need attention.",
          openCount: "open",
          totalCount: "records",
          ack: "Acknowledge",
          resolve: "Resolve",
        ...
        memory: {
          ...
          description: "Facts, procedures, reflections, and preferences learned from past research.",
          totalCount: "active memories",
          empty: "No project memories yet. Completed research will build them over time.",
        },
        artifacts: {
          eyebrow: "OUTPUT LIBRARY",
          title: "Research artifacts",
          description: "Browse project factors, strategy versions, and backtest results in one place.",
          factors: "Factors",
          strategies: "Strategies",
          backtests: "Backtests",
          backtest: "Backtest",
          empty: "No artifacts yet. Start factor or strategy research from chat.",
        },
      },
    },
    sidebar: {
    ...
    chat: {
      sidebar: {
        ...
        layoutGroupAria: "Session list layout",
        actionsAria: "Session actions",
        layoutTop: "Top",
        layoutLeft: "Left",
        layoutTopTitle: "Place session list above the chat",
        layoutLeftTitle: "Place session list to the left of the chat",
      },
      board: {
        show: "Show board",
        hide: "Hide board",
    ...
    team: {
      ...
      hitl: {
        inputArea: {
          ...
          optionalPlaceholder: "Optional notes (≤500 characters)",
          optional: "optional",
        },
        submit: {
        ...
        validation: {
          ...
          needField: "Please fill in “{label}”",
    ...
    proShell: {
      explorer: {
        sectionsAria: "Explorer sections",
        pages: "Pages",
        sessions: "Sessions",
        workspace: "Workspace",
        assets: "Assets",
      ...
      workspace: {
        ...
        empty: "No workspace data yet",
        factorsFolder: "factors",
        strategiesFolder: "strategies",
        dataDirHint: "Data dir follows backend QUBIT_DATA_DIR",
      },
      assets: {
        strategies: "Strategies",
        factors: "Factors",
        positions: "Positions / runs",
        emptyStrategies: "No strategy versions",
        emptyFactors: "No factors",
        emptyPositions: "No strategy runtimes (see Trader for positions)",
        positionsHint: "Showing strategy runtimes; open Trader for full positions.",
        openTrader: "Open Trader →",
        sourceWorkshop: "Workshop",
        sourceWorkspace: "Workspace projection",
        needWorkspace: "Select a workspace topic in Explorer first",
        providerKind: "Provider: {kind}",
        providerUnknown: "Provider: —",
        syncFromWorkshop: "Sync from workshop",
        syncing: "Syncing…",
        syncDone: "Synced factors {factors} · strategies {strategies}",
        emptyWorkspaceStrategies: "No projected strategies yet. Use Sync from workshop.",
        emptyWorkspaceFactors: "No projected factors yet. Use Sync from workshop.",
      },
      agent: {
        title: "Agent",
        teamTitle: "Orchestrator",
        hide: "Hide",
      ...
      status: {
        ...
        agentAwaiting: "Agent: AWAITING_HITL",
      ...
      chat: {
        ...
        focusAgent: "Focus Agent panel",
        showCenterChat: "Open chat in center",
      },
      command: {
        ...
        groupWorkspace: "FS workspaces",
        toPro: "Switch to Pro workbench",
        toSimple: "Switch to Simple chat",
        openExplorer: "Open Explorer",
        current: "current",
