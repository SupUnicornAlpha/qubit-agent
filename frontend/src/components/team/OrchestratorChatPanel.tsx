...
const styles: Record<string, CSSProperties> = {
  ...
  artifactCard: {
    ...
    gap: 8,
    padding: "6px 8px",
    background: "var(--qb-team-panel-bg, #0c0c0e)",
  ...
  artifactKind: {
    ...
    padding: "1px 6px",
    borderRadius: 4,
    border: "1px solid var(--qb-blue, rgba(96,165,250,0.5))",
  ...
  artifactSub: { flexShrink: 0, fontSize: 10, color: "var(--qb-body-muted, #71717a)" },
  artifactOpen: { flexShrink: 0, fontSize: 10, color: "var(--qb-blue, #60a5fa)" },
  injectHint: {
    fontSize: 11,
    color: "#86efac",
  ...
  memoryPickItemActive: {
    background: "var(--qb-tint, rgba(56,189,248,0.15))",
    color: "var(--qb-blue, #7dd3fc)",
  },
  memoryAtBtn: {
    flexShrink: 0,
    border: "1px solid var(--qb-team-input-border, #3f3f46)",
