...
import "./theme/quant-backtest-report.css";
import "./theme/quant-light.css";
import "./theme/transitions.css";
import "./theme/styles/vscode-dark.css";
import "./theme/styles/vscode-light.css";
import "./theme/styles/jetbrains-darcula.css";
...
import "./theme/pro-ide-consistency.css";
import "./theme/simple-mode.css";
import "./theme/prime-chrome.css";
import "./theme/trading-console.css";
import "./theme/market-workspace.css";
import "./theme/flexlayout-theme.css";
